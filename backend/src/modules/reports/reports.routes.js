...
router.get('/balances', authenticate, authorize('faculty'), controller.balanceReport);
router.get('/sanctions-stats', authenticate, authorize('faculty'), controller.sanctionReport);
